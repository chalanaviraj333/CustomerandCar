...
@Component({
  selector: 'app-photoidfrontpage',
  templateUrl: './photoidfrontpage.page.html',
  styleUrls: ['./photoidfrontpage.page.scss'],
})
export class PhotoidfrontpagePage implements OnInit {
  ...
  async onClickNext() {
    ...
    await this.photoService.uploadPhotoIdFrontPage(this.customerData, this.enteredCarRego);    
  }
